...
//                this.SubjectLimit = 30;                
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            try
            {
                ...
                stream.Write(SH_hmjh_SemesterScoreReport.Properties.Resources.和美_個人學期成績單樣板, 0, SH_hmjh_SemesterScoreReport.Properties.Resources.和美_個人學期成績單樣板.Length);
                stream.Flush();
                stream.Close();
        ...
        private void linkLabel2_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            try
            {
                //document.Save(path, Aspose.Words.SaveFormat.Doc);
                System.IO.FileStream stream = new FileStream(path, FileMode.Create, FileAccess.Write);
                stream.Write(SH_hmjh_SemesterScoreReport.Properties.Resources.歡樂的合併欄位總表, 0, SH_hmjh_SemesterScoreReport.Properties.Resources.歡樂的合併欄位總表.Length);
                stream.Flush();
                stream.Close();
                System.Diagnostics.Process.Start(path);
            }
